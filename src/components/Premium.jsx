...
const Premium = () => {
    ...
    return isUserPremium ? (
        <div className="min-h-[80vh] pt-32 pb-24 px-4 flex items-center justify-center bg-transparent">
        ...
        <div className="min-h-[80vh] pt-28 pb-12 mb-10 px-4 flex flex-col items-center justify-center bg-transparent">
            ...
            <div className="flex flex-col xl:flex-row gap-6 w-full max-w-6xl justify-center items-stretch perspective-1000">
                {plans.map((plan, index) => {
                    ...
                    return (
                        <div key={index} className="relative group w-full xl:w-[360px]">
                            {plan.popular && (
                            ...
                            <div className={`relative h-full flex flex-col p-6 rounded-3xl bg-white dark:bg-zinc-900 shadow-xl transition-transform duration-300 ${plan.popular ? "border border-amber-500/30 hover:-translate-y-3 shadow-2xl scale-100 md:scale-105 z-10" : "border border-zinc-200 dark:border-zinc-800 hover:-translate-y-2"} `}>
                                ...
                                <div className="mb-5">
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <span className="text-zinc-500 dark:text-zinc-400 font-medium ml-1 text-xs md:text-sm">{plan.duration}</span>
                                    </div>
                                </div>
                                ...
                                <button
                                    ...
                                    className={`w-full py-3 md:py-4 rounded-xl font-bold text-base md:text-lg shadow-sm transition-all ${plan.popular
                                        ? "bg-gradient-to-r from-amber-500 to-pink-500 text-white hover:opacity-90 shadow-lg shadow-amber-500/25"
